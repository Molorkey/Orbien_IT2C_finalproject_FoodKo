                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-custom">
                        <div class="contact-info-item">
                            ...
                            <?php
                                ...
                                echo '<p>Santol, Boac, Marinduque / (042) 123 456 789 foodko@email.com</p>';
                            ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-custom">
                        <div class="contact-info-item">
                            ...
                            <div class="con-info-txt">
                            <?php
                                echo '<h4>Contact us Anytime</h4>';
                                echo '<p>Mobile: 012 345 678</p>';
                            ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-custom text-align-center">
                        <div class="contact-info-item">
                            ...
                            <div class="con-info-txt">
                            <?php
                                echo '<h4>Support Overall</h4>';
                                echo '<p>Support24/7@example.com <br> foodko@example.com</p>';
                            ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-custom">
                        <form method="post" action="assets/php/mail.php" id="contact-form" accept-charset="UTF-8" class="contact-form">
                            ...
                            <?php
                                    echo '<h5 class="text-uppercase">Get in Touch</h5>';
                            ?>
                                <div class="row mt-3">
