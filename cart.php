                        ...
                        <div class="cart-table table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                    <?php
                                        echo '<th class="pro-thumbnail">Image</th>';
                                        echo '<th class="pro-title">Product</th>';
                                        echo '<th class="pro-price">Price</th>';
                                        echo '<th class="pro-quantity">Quantity</th>';
                                        echo '<th class="pro-subtotal">Total</th>';
                                        echo '<th class="pro-remove">Remove</th>';
                                    ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        echo '';
                                    ?>                                        
                                            <td class="pro-title"><a href="#"><?php $item=simplexml_load_file('Orbien_IT2yoursection_FoodKo.xml'); 
                                                    echo $item->food[5]->name;
                                            ?></a></td>
                                            <td class="pro-price"><span><?php $item=simplexml_load_file('Orbien_IT2yoursection_FoodKo.xml'); 
                                        ...
                                        <?php
                                            echo '<td class="pro-subtotal"><span>PHP145.00</span></td>';
                                        ?>
                                    ...
                                    ?>                                        
                                        ...
                                        <td class="pro-subtotal"><span>PHP50.00</span></td>
                                        <td class="pro-remove"><a href="#"><i class="ion-trash-b"></i></a></td>
                                    </tr>
                                    <tr>
                                    ...
                                    ?>                                        
                                        ...
                                        <td class="pro-subtotal"><span>PHP75.00</span></td>
                                        <td class="pro-remove"><a href="#"><i class="ion-trash-b"></i></a></td>
                                    </tr>
                    ...
                    <div class="col-lg-5 ml-auto">
                        ...
                        <div class="cart-calculator-wrapper">
                            ...
                            <?php
                                ...
                                echo '<tr class="total">';
                                echo '<td>Total</td>';
                                echo '<td class="total-amount">PHP300</td>';
                            ?>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <?php
                                echo '<a href="checkout.php" class="btn obrien-button primary-btn d-block">Proceed To Checkout</a>';
                            ?>
                        </div>
                    </div>
                </div>
